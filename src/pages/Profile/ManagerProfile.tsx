                ...
                <Link key={v.id} to={`/venues/${v.id}`} className="h-full">
                    ...
                    <div className="flex gap-2 mt-4">
                        <button onClick={(e) => {
                            ...
                            className="mt-auto bg-[#4996FC] text-white px-3 py-1 rounded hover:bg-[#1c73e5] dark:bg-[#1557ae] dark:hover:bg-[#114a94] transition">
                            Edit
                        </button>
                        <button onClick={(e) => {
                            e.preventDefault();
                            ...
                            className="mt-auto bg-[#F53232] text-white px-3 py-1 rounded hover:bg-[#c02424] dark:bg-[#ad1414] dark:hover:bg-[#850f0f] transition">
                            Delete
                        </button>
                    </div>
                    </div>
