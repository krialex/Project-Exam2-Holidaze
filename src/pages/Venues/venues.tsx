    ...
    return (
        ...
        {venue && (
            <div className="max-w-4xl mx-auto my-6 p-4">
                ...
                <div className="w-56 flex flex-row gap-2 items-center">
                    <p className="italic font-normal">Created by {venue.owner.name}</p>
                    <img src={venue.owner.avatar.url} alt={venue.owner.avatar.alt} className="w-11 rounded-full" />
                </div>
