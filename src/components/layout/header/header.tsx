...
export function Header({ darkMode, setDarkMode, onSearch, searchTerm }: HeaderProps) {
    ...
    <header className="w-full bg-gradient-to-b from-[#6223F7] to-[#BBE1FF] text-white">
      <div className="max-w-[1600px] mx-auto p-6">
        <div className="flex justify-between items-center">
          <Link to="/" onClick={() => onSearch("")} className="flex items-center gap-5 text-white text-2xl no-underline flex-grow">
