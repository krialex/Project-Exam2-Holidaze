...
// nå kan det updates og lages ny venue. trenger å lage en delete. husk å sette på
// prevent default og slikt så man ikke blir navigert videre når man trykker på delete-knappen
